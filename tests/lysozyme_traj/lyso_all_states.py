...
pDynamo_root = os.path.join(
    os.environ["HOME"], "local", "opt", "pDynamo-%s" % pDynamo_version
)
...
pDynamo_pmoleculescripts = os.path.join(
    pDynamo_root, "pMoleculeScripts-%s" % pDynamo_version
)
