...
class PQRFileWriter(TextFileWriter):
    ...
    def WriteSystem(self, system, data=None, selection=None, charges=None, radii=None):
        ...
        if natoms != xyz.rows:
            raise TypeError(
                "The PQR model and coordinate data are of different lengths."
            )
        ...
        if charges is None:
            ...
            if natoms != len(charges):
                raise TypeError(
                    "The PQR model and charge data are of different lengths."
                )
        ...
        if radii is None:
            ...
            if natoms != len(radii):
                raise TypeError(
                    "The PQR model and radii data are of different lengths."
                )
